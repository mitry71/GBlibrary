    ...
    <script type="text/javascript">
	    function fn_sendMember() {
			...
			if(id.length < 4 || id.length > 10) {
				alert("아이디에는 4~10자리의 영문과 숫자만 입력해주세요");
			}
			//비밀번호 자릿수 체크
			...
			//비밀번호 동일 여부 확인
				...
				joinForm.action="${contextPath}/member/join.do";
				joinForm.submit();
			}
		}
    	...
    	function popup_IDchk() {
			...
			window.open("idCheck.jsp","_blank","width=500,height=300,left="+popupX+",top="+popupY);
		}
    </script>
</head>
<body>
            ...
            <div id="container">
                ...
                <div class="snb">
                    ...
                    <ul>
                        ...
                        <li><a href="join.jsp" class="selected_menu">회원가입</a></li>
                ...
                <div class="main-content">
                    ...
                    <h2>회원가입</h2>
                    <p id="location">Home &gt; 회원정보 &gt; 회원가입</p>
                    ...
                    <form id="joinForm" name="joinForm">
                        <fieldset>
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" required placeholder="홍길동" autocomplete="off">
                            </div>
                            <div>
                                <label for="id">아이디<strong class="require">필수</strong></label>
                                <input type="text" name="id" id="id" required placeholder="Guest">
                                <a id="idCheck" onclick="popup_IDchk()">ID 중복확인</a>
                            </div>
                            <div>
                                <label for="pass">비밀번호<strong class="require">필수</strong></label>
                                <input type="password" name="pass" id="pass" required placeholder="영문/숫자 4~8자 이내">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="phoneNumber1" id="phoneNumber1" maxlength="3" size="3">-<input type="text" name="phoneNumber2" id="phoneNumber2" maxlength="4" size="4">-<input type="text" name="phoneNumber3" id="phoneNumber3" maxlength="4" size="4">
                            </div>
                            <div>
                            ...
                            <div class="btnArea">
                                <input type="submit" class="btnJoin" onclick="fn_sendMember()" value="회원가입">
